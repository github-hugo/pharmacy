...
(function($, undefined) {
    ...
    $.validity = {
        ...
        patterns:{
           ...
           // date:/^((0?\d)|(1[012]))-([012]?\d|30|31)\-\d{1,4}$/,
            ...
            fourFloatNum:/^(([1-9])([0-9]+)|([1-9]+)|([0-9]+\.[0-9]{1,4}))$/,  //juan自己加的小数点后边四位小数的验证;
            
            mypassword:/^[A-Za-z0-9_]{4,10}$/,
        ...
        messages:{
            ...
            date1:"#{field} must be formatted as a date. (mm/dd/yyyy)",
            email:"#{field} must be formatted as an email.",
            usd:"#{field} must be formatted as a US Dollar amount.",
            url:"#{field} must be formatted as a URL.",
            number:"#{field} must be formatted as a number.",
            positive_number:"#{field} must be formatted as a positive number.",
            ...
            fourFloatNum:"#{field}为>0的数值型，且小数不超过四位.",  //juan 自己加的验证规则;
            mypassword:"密码为字母、数字、或_长度为4-10",
            generic:"Invalid."
        },
    ...
    $.fn.extend({
        ...
        // TODO: Document
        radioChecked:function(msg) {
            // If a reduced set is attached, use it.
            // Also, remove unsupported elements.
            var $reduction =  (this.reduction || this).filter($.validity.settings.elementSupport);
            
            if ($reduction.is(":radio") && !$reduction.is(":checked")) {
                raiseAggregateError(
                    $reduction,
