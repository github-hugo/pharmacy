...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E://MpGenerator_data");
...
//        gc.setAuthor("caoyy");
        ...
        // 包配置
        String moduleName = "pharmacy";
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.xinhe.pharmacy");
        pc.setEntity("entity");
...
//            @Override
                        ...
                        : (t.contains("int") ? DbColumnType.INTEGER
                                : (!t.contains("date") && !t.contains("time") && !t.contains("year") ? (
                                        t.contains("text") ? DbColumnType.STRING
                                                : (t.contains("bit") ? DbColumnType.BOOLEAN
        ...
        dsc.setUrl("jdbc:mysql://47.96.112.137:3306/pharmacy?characterEncoding=utf8");
...
//        strategy.setTablePrefix(new String[] { "yunxin_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[]{"medicine"}); // 需要生成的表
...
//        focList.add(new FileOutConfig("/template/listComplain.jsp.vm") {
//            @Override
...
//        mpg.setCfg(cfg);
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return "E://MpGenerator_data//resources//" + tableInfo.getEntityName() + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
